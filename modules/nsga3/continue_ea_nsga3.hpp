/*
 * continue_ea_nsga3.hpp
 *
 *  Created on: Mar 1, 2018
 *      Author: Joost Huizinga
 *
 * A wrapper for NSGA3 (and derived algorithms) that allows the EA to be resumed from a checkpoint.
 */

#ifndef MODULES_NSGA3_CONTINUE_EA_NSGA3_HPP_
#define MODULES_NSGA3_CONTINUE_EA_NSGA3_HPP_
 ...
 * Implements:
 * - set_gen(size_t gen)
 *   Allows the EA to start at a generation that isn't generation 0.
 *
...
class ContinueNsga3 : public EA_t{
public:
...
#endif /* MODULES_NSGA3_CONTINUE_EA_NSGA3_HPP_ */
