...
namespace OGLFT {
  ...
  public:
     ...
     * Defaults to 100 DPI.
     */
    Face ( const char* filename, float point_size = 12, FT_UInt resolution = 100, FT_Long style_flags = 0 );
  ...
  public:
    ...
    Polygonal ( const char* filename, float point_size = 12,
		FT_UInt resolution = 100, FT_Long style_flags = 0 );
  ...
  public:
     ...
     * Defaults to 100 DPI.
     */
    Solid ( const char* filename, float point_size = 12, FT_UInt resolution = 100, FT_Long style_flags = 0  );
  ...
  public:
     ...
     * Defaults to 100 DPI.
     */
    Raster ( const char* filename, float point_size = 12, FT_UInt resolution = 100, FT_Long style_flags = 0  );
    /*!
     * \param face open FreeType FT_Face.
     * \param point_size the initial point size of the font to generate. A point
     * is essentially 1/72th of an inch. Defaults to 12.
  ...
  public:
    ...
    Texture ( const char* filename, float point_size = 12,
	      FT_UInt resolution = 100, FT_Long style_flags = 0, int filter_size = 0);
  ...
  private:
    GLubyte* createBlurredTexture (GLubyte* source, int* width, int* height, int bitwidth, int bitheight );
    GLubyte* invertPixmap ( const FT_Bitmap& bitmap, int* width, int* height );
    void bindTexture ( FT_Face face, FT_UInt glyph_index );
  };
